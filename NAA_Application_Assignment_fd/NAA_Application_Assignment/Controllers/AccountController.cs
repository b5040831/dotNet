...
namespace NAA_Application_Assignment.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            _AccountContext = new ApplicationDbContext(); 
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToAction("GetUserIDLogic");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("CreateUserProfile", new { UserID = user.Id, Controller = "Admin" });
                }
                AddErrors(result);
            }
